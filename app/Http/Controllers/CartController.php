...
class CartController extends Controller
{
    ...
    public function del_all_product(){
        ...
        if($cart==true){
            ...
            return redirect()->back()->with('message','Xóa toàn bộ sản phẩm thành công');
        }
    ...
    public function show_cart(){
    	...
    	$cate_product = DB::table('tbl_category_product')->where('category_status','0')->orderby('category_id','desc')->get();
    	$brand_product = DB::table('tbl_brand')->where('brand_status','0')->orderby('brand_id','desc')->get();
    	return view('pages.cart.show_cart')->with('category',$cate_product)->with('brand',$brand_product)->with('category_post',$category_post);
    }
