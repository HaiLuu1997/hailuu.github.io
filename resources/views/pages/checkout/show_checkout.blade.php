						...
						<div class="bill-to">
							...
							<div class="form-one">
								<form action="{{URL::to('/save-checkout-customer')}}" method="POST">
									...
									<textarea name="shipping_notes" placeholder="Ghi chú gửi hàng" class="shipping_notes" rows="5"></textarea>
									@if(Session::get('fee'))
                                ...
                                <input type="button" value="Tính phí vận chuyển" name="calculate_delivery" class="btn btn-primary btn-sm calculate_delivery">	
                            </form>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<li>
									<a class="cart_quantity_delete" href="{{URL::to('/del-fee/')}}"><i class="fa fa-times"></i></a>Phí vận chuyển :<span>{{number_format(Session::get('fee'),0,',','.')}}VNĐ</span></li>
									<?php
